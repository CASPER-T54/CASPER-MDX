...
//================= { BOT SETTINGS } =================\\
// Bot name
globalThis.botName = "CASPER-X"

// Bot version
globalThis.botVersion = "1.0.2"
...
globalThis.owner = [
  {
    number: "254732982940", // primary owner number
    name: "TRABY", // owner name
...
globalThis.ownerName = "TRABY"

// Owner contact info
globalThis.ownerContact = {
  email: "caspertechke@gmail.com",
  website: "https://github.com/Casper-Tech-ke/CASPER-X",
}
...
globalThis.sessionCleanupInterval = 12
...
const restartBot = () => {
  console.log(chalk.yellow("Config updated, restarting CASPER-X bot..."))
